...
export function CreateProductForm({ onClose }: { onClose?: () => void }) {
  ...
  const isValid = email !== "" && name.trim() !== "" && githubRepo.trim() !== "";
  ...
  return (
    <form action={async (formData) => {
      ...
      <div className="space-y-1">
        <label htmlFor="name" className="block text-[11px] font-bold text-gray-400 tracking-wider uppercase">
          Friendly Name
        </label>
        <input
          type="text"
      ...
      <div className="space-y-1">
        <label htmlFor="githubRepo" className="block text-[11px] font-bold text-gray-400 tracking-wider uppercase">
      ...
      <div className="space-y-4">
        ...
        {isPrivate && (
          <div className="space-y-1 animate-in fade-in slide-in-from-top-2 duration-200">
            <label htmlFor="githubToken" className="block text-[11px] font-bold text-gray-400 tracking-wider uppercase">
      ...
      <div className="pt-2">
        ...
        >
          {email ? "Save Software Profile" : "Loading..."}
        </button>
      </div>
    </form>
  );
